...
export const LeaderboardSidePanel = () => {
  ...
  return (
    <Container
      fluid
      className={`${styles.banner} ${styles.bottomRadius728} ${styles.gradient3}`}
    >
      <span ref={logoRef3}></span>
      ...
      <Container fluid className={styles["btn-pin-right"]} ref={btnRef3}>
        <Row>
          <Col>
            <button className={"repeat-btn"} onClick={runBannerAnimation3}>
              Run Again
            </button>
          </Col>
        </Row>
      ...
      <div
        className={styles["animated-panel"]}
        ref={aniPanelRightSide728}
      ></div>
    </Container>
  );
};
