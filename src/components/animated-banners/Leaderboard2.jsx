...
export const LeaderboardTopPanel = () => {
  ...
  return (
    <Container
      fluid
      className={`${styles.banner} ${styles.noRadius728} ${styles.gradient2}`}
    >
      <span ref={logoRef2}>
        <img
          width="65px"
      ...
      <span className={`${styles.text}`} ref={textRef2}>
        Donec id magna
      </span>
      ...
      <div className={styles["animated-panel"]} ref={aniPanelTop728}>
        Space...
      </div>
